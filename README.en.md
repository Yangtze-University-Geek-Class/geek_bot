...
- Architecture and security model are drafts ([ARCHITECTURE](docs/architecture/ARCHITECTURE.md), [SECURITY](docs/architecture/SECURITY.md), status `proposed`), finalized in #2.
