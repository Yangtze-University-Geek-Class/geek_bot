...
状态：`current` · 更新：2026-09-25 · 适用：English-speaking readers; the rules live in COMMITS.md.
...
- Scopes: `control`, `console`, `node`, `runner`, `protocol`, `deploy`, `docs`, `tooling`, `deps`, `release`, `security`. Pick the one that owns the change.
