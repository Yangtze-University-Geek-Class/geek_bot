...
状态：`current` · 更新：2026-09-25 · 适用：整个仓库；所有维护者、贡献者与 AI/Agent。
...
**批准与合并始终由人来做。** 截至 2026-09-25，上述功能都还没实现，由 #2–#21 逐项交付。
...
| `app/console` | `@geek-bot/console` | 管理后台。Vue 3.5 + vue-router 4 + @talex-touch/tuffex 0.6.0 + Vite（计划中，#4 引入）。不用原生下拉框和复选框，不用 emoji。见 [console](../services/console/README.md) |
