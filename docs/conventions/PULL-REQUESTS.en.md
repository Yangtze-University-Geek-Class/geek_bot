...
状态：`current` · 更新：2026-09-25 · 适用：English-speaking readers; the rules live in PULL-REQUESTS.md.
...
- `pnpm verify` must pass; merging, releasing and deploying are separate authorized actions.
