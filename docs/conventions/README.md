...
状态：`current` · 更新：2026-09-25 · 适用：本仓库的所有维护者、贡献者与 AI/Agent。
...
这些规范是**强制**的。根 [AGENTS.md](../../AGENTS.md) §0 把 AGENT-START、PROJECT、BRANCHING、CONTRIBUTING、CODE-REVIEW、RELEASES、TRACKING 列为首步必读，其余按 [AGENT-START](AGENT-START.md) 的任务表读取；改某项内容前必须先读对应那篇。服务级文档见 [docs/services](../services/README.md)。
